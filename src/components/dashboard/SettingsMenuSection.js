    ...
    return (
        <div className="dashboard--menu__section">
            ...
            <ul className="dashboard--section__list">
                ...
                {userType === 'pm' 
                && <li onClick={showModal} className="dashboard--list__item" ><p className="dashboard--menu__link"><span className="dashboard--link__icon" role="img" aria-label="bang-emoji" >💥</span>Create New Project</p></li>}
            </ul>
        </div>
    )
}
